...
namespace Examples {
	class AssertingInteraction : public ::testing::Test
	{
	};
	...
	*/
	TEST(AssertingInteraction, AssertCallWasMadeOnDependency)
	{
		//Arrange
		auto a = Isolator();
		Person person;
	...
	*/
	TEST(AssertingInteraction, AssertCallWasMadeWithSpecificArgumentsOnDependency)
	{
		//Arrange
		auto a = Isolator();
		Person person;
	...
	*/
	TEST(AssertingInteraction, AssertCallWasMadeWithSpecificArgumentsOnDependencyWithPredicates)
	{
		//Arrange
		auto a = Isolator();
		Person person;
	...
	*/
	TEST(AssertingInteraction, AssertCallWasNotMadeOnDependency)
	{
		//Arrange
		auto a = Isolator();
		Address* pAddress = a.Fake.Instance<Address>();
	...
	*/
	TEST(AssertingInteraction, TimesCalledMethodOnDependency)
	{
		//Arrange
		auto a = Isolator();
		Person person;
	...
	*/
	TEST(AssertingInteraction, WasNotCalledWithConcreteOutParam)
	{
		//Arrange
		auto a = Isolator();
	...
	*/
	TEST(AssertingInteraction, WasCalledWithConcreteOutParam)
	{
		//Arrange
		auto a = Isolator();
