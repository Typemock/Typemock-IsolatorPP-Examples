...
*/
	class FutureObjectTests : public ::testing::Test
	{
	...
	*/
	TEST(FutureObjectTests, FakingTheSingletonObjectAndChangingBehavior)
	{
		//Arrange
		auto a = Isolator();
	...
	*/
	TEST(FutureObjectTests, FakingTheSingletonObjectAndAssertingMethodCalls)
	{
		//Arrange
		auto a = Isolator();
		Address* fakeAddressHandle = a.Fake.All<Address>();
