...
namespace Examples {
	TEST_CLASS(AssertingNonPublicInteraction)
	{
	public:
		/*****************************************
		...
		*/
		TEST_METHOD(AssertOverloadCallWasMadeOnDependency)
		{
			//Arrange
			auto a = Isolator();
			Person person;
		...
		*/
		TEST_METHOD(AssertPrivateWithCondition)
		{
			//Arrange
			auto a = Isolator();
		...
		*/
		TEST_METHOD(AssertPrivateWithConditionWasNotCalled)
		{
			//Arrange
			auto a = Isolator();
			Person* person = new Person();
		...
		*/
		TEST_METHOD(AssertPrivateWithConditionWasCalledWithRet)
		{
			//Arrange
			auto a = Isolator();
		...
		*/
		TEST_METHOD(AssertPrivateWithConditionWasNotCalledWithRet)
		{
			//Arrange
			auto a = Isolator();
